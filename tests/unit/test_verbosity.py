...
from src.mcp_server_troubleshoot.files import FileInfo, FileListResult, FileContentResult, GrepResult, GrepMatch
...
class TestVerbositySystem(unittest.TestCase):
    ...
    def test_formatter_initialization(self):
        ...
        # Test with None defaults to minimal
    ...
    def test_token_savings(self):
        ...
        self.assertGreaterEqual(savings_percentage, 30.0, 
                              f"Token savings {savings_percentage:.1f}% below 30% target")
