...
class KubectlExecutor:
    ...
    async def execute(self, command: str, timeout: int = 30, json_output: bool = True) -> KubectlResult:
        """
    ...
    async def _run_kubectl_command(
        ...
        try:
            ...
            # Process the output
            output, is_json = self._process_output(stdout_str, process.returncode == 0 and json_output)
